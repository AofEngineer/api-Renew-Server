...
const insert = (req, res) => {
  connection.query("SELECT * FROM `m_company`", (err, results) => {
    if (err) return res.status(404).json({ message: "Invalid inputdata" });
    res.status(200).json(Object.keys(results[0]));
  });
};
